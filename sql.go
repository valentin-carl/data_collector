...
CREATE TABLE IF NOT EXISTS %s (
	timestamp INTEGER, 
	total_workflow_duration INTEGER, 
	total_execution_duration INTEGER
);`, tableName)
...
func insertMeasurement(dbc *sql.Conn, tableName string, timeStamp uint64, totalWorkflowDuration uint64, totalExecutionDuration uint64) (int64, error) {
